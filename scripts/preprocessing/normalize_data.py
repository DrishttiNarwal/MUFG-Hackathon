...
# Schema 
NUMERIC = [
    "age", "annual_premium", "sumassured",
    "num_diseases", "priceofvehicle", "ageofvehicle", 
    "tripdurationdays", "propertyvalue", "propertyage", "propertysizesqfeet",
    "trippremium"
]

CATEGORICAL = [
    "country", "policytype", "smokerdrinker", "diseases",
    "typeofvehicle", "destinationcountry", "existing_medical_condition",
    "healthcoverage", "baggagecoverage",
